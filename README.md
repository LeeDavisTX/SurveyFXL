...
and survey data never leaves the machine it is opened on. The only network
call the page makes is loading Montserrat and Open Sans from Google Fonts;
without a connection it falls back to the system's own sans-serif and
