...
function fxlFromCodes(codes, filename) {
...
/* A single entry point for bringing a library in, with a choice of format -
   an FXL/XML/zip file, or an Excel workbook exported from this app. Either
   replaces the library currently loaded. */
    ...
    body: h("div", { class: "stack" }, [
      ...
      h("div", { class: "import-opt" }, [
        h("div", {}, [
          ...
          h("div", { class: "import-opt-s", text: "A .xlsx with Codes / Attributes / Options sheets, as exported by “Export XLS”" }),
        ]),
        xlsxPicker,
      ]),
      h("p", { class: "modal-note" }, "Either option replaces the feature library currently loaded. Survey data already loaded is kept."),
    ]),
