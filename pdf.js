...
/* Attribute type labels come from TYPE_LABEL in app.js rather than a second
   copy here, so the report and the editor can never disagree about what a
   type is called. */
  ...
  for (const code of codes) {
    ...
    attrs.forEach((a, i) => {
      ...
      if (doc) {
        ...
        doc.text(COL.dict.x, y, TYPE_LABEL[a.tag] || "Text", "mono", 7.5, PDF_INK2);
